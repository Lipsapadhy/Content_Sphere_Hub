...
const PostDetails = () => {
  ...
  const isAdmin = userAuth?.userInfo?.role === 'admin';
  ...
  return (
      ...
      >
        ...
        {/* move image inside a container + inner max-width */}
        <div className="container px-4 mx-auto">
        ...
        {/* smaller Posts stats */}
        <div className="flex justify-center items-center transform scale-75 my-4">
          <PostStats
        ...
        <div className="container px-4 mx-auto">
          <div className="mx-auto md:max-w-3xl">
            {/* ≣ Spacer: approx. 4 lines of gap */}
            <div className="my-16" />
            {/* Render HTML content */}
            <div
                className="pb-10 mb-8 text-lg font-medium border-b md:text-xl text-coolGray-500 border-coolGray-100"
                dangerouslySetInnerHTML={{ __html: post?.post?.content }}
            />

            {/* delete and update icons for creator or admin */}
            {(isCreator || isAdmin) && (
                <div className="flex justify-end mb-4">
                  ...
                  >
                    {/* SVG omitted for brevity; same as before */}
                    <svg
