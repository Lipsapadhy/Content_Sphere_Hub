      ...
      <section className="relative py-24 bg-white">
        ...
        <div className="container relative z-10 px-4 mx-auto">
          ...
          <ul className="flex flex-wrap mb-8 -mx-2 text-center">
            ...
            <li className="w-full md:w-auto px-2">
              <a
                className="inline-block w-full py-2 px-4 text-sm text-coolGray-400 hover:text-green-500 hover:bg-green-200 font-bold rounded-md hover:shadow-sm"
                href="#"
              >
                Start-up
              </a>
...
export default PostsListsTemplate;
